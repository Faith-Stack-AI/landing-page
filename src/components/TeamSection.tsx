...
const TeamMember: React.FC<TeamMemberProps> = ({ name, role, bio, imageSrc, socialLinks }) => {
  return (
    <div className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow p-6 md:p-8 flex flex-col items-center text-center">
      ...
      <h3 className="text-2xl font-medium mb-1">{name}</h3>
      <p className="text-[#8773e3] font-medium mb-4">{role}</p>
      <p className="text-gray-700 mb-6">{bio}</p>
      
      <div className="flex space-x-4">
        {socialLinks.linkedin && (
          <a href={socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#8773e3] transition-colors">
        ...
        {socialLinks.twitter && (
          <a href={socialLinks.twitter} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#8773e3] transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {socialLinks.github && (
          <a href={socialLinks.github} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#8773e3] transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
